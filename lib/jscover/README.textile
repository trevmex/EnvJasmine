...
At the top of the file, set @properties_file@ to the properties file location.

h3. envjasmine-sonar-coverage-properties.js

Update all of the variables in this file to the correct location or value
...
This script file starts by loading it's dependencies including properties and helper functions. It also create temp directories.
...
versions 0.9: initial release. 1/11/2013
versions 1.0: Removed python dependency. Simplified configuration. Made sonar-runner the default sonar method. 1/17/2013
